...
def compress(args):
  ...
  for i in tqdm(range(1)):
      ...
      with tf.Session() as sess:
        ...
        bpp.append(eval_bpp.eval())
        full_bpp.append((len(packed.string) * 8 / num_pixels).eval())
        # plt.imsave("compressed.png", x_hat.eval()[0]/255.)
        # print(packed.string)
        op = write_png("test.png", x_hat)
        sess.run(op)
